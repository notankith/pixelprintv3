...
export const Dashboard: React.FC<DashboardProps> = ({ onNavigateToEditor }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full h-2 bg-gray-300 mt-8" />
      <footer className="w-full text-center py-4 mt-0 border-t-2 border-gray-300" style={{ backgroundColor: '#9d8274' }}>
        <a href="https://ankith.studio" target="_blank" rel="noopener noreferrer" className="text-white font-medium hover:underline">
          ankith.studio
        </a>
      </footer>
    </div>
