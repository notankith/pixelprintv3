      ...
      try {
        ...
        try {
          ...
          try {
            ...
            dataUrl = html2canvasResult.toDataURL('image/png', 0.8);
            exportMethod = 'html2canvas-direct';
            ...
            try {
              ...
              // Try to copy the original canvas
              try {
                ctx.drawImage(originalCanvas, 0, 0);
                dataUrl = newCanvas.toDataURL('image/png', 0.8);
                ...
                // Method 4: Manual text rendering (guaranteed to work)
                ...
                for (const obj of objects) {
                  if ((obj as any).type === 'text') {
                    ...
                    const y = (textObj.top || 0) + (textObj.fontSize || 16);
