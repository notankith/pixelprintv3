          ...
          try {
            ...
            try {
              ...
              try {
                    ...
                    if ((obj as any).type === 'image') {
                      ...
                      if (imgObj._element && 
                        ...
                        try {
                          ...
                          console.log('❌ Failed to draw image, creating placeholder:', imgDrawError);
                        ...
                        console.log('❌ Image not ready or broken, drawing placeholder');
                ...
                console.log('✅ Safe manual rendering succeeded');
              }
            } catch (manualError) {
