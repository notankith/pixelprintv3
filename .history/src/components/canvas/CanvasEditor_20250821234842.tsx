          ...
          try {
            ...
            try {
              ...
              try {
                ...
                // Method 4: Manual text rendering with exact positioning
                console.log('Attempting manual text rendering...');
                const objects = fabricCanvas.getObjects();
                ...
                for (const obj of objects) {
                  ...
                  // Note: Skipping images to avoid CORS issues in this fallback
                }
                
                dataUrl = newCanvas.toDataURL('image/png', 0.95);
                exportMethod = 'manual-render';
                console.log('✅ Manual text rendering succeeded');
              }
            } catch (manualError) {
