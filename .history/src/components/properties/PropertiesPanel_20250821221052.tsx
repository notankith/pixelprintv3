...
export const PropertiesPanel = ({ selectedElement, onElementUpdate }: PropertiesPanelProps) => {
  if (!selectedElement) {
    return (
  ...
  return (
    <div className="space-y-6 properties-panel" onClick={(e) => e.stopPropagation()} onMouseDown={(e) => e.stopPropagation()}>
