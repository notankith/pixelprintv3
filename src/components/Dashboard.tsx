...
export const Dashboard: React.FC<DashboardProps> = ({ onNavigateToEditor }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-beige">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button 
              ...
              className="mt-4 sm:mt-0 bg-pastel-green hover:bg-pastel-blue text-pastel-purple border-none"
              size="lg"
            >
                ...
                <CardContent className="pt-0 bg-pastel-yellow rounded-b-md">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      className="flex-1 bg-pastel-green hover:bg-pastel-blue text-pastel-purple border-none"
                    >
                    ...
                    <Button
                      ...
                      className="px-2 hover:bg-pastel-pink hover:border-pastel-purple border-none"
                    >
      ...
      <footer className="w-full bg-pastel-blue text-center py-4 mt-0 border-t border-pastel-purple">
